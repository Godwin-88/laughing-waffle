...
flowchart LR
    ...
    subgraph API["apps/api · Fastify 5 (:4000 /api/v1)"]
        M["Modules<br/>auth · profile · catalogue · enrolments · video · builder<br/>quizzes · checkout · certificates · admin · gdpr<br/>discussions · notifications · oauth · lti<br/>public-api · analytics · saml<br/>bulk-enrolment · offline"]
        DB[("PostgreSQL 16")]
